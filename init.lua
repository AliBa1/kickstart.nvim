...
require('lazy').setup({
  ...
  --         --    Find snippets for each langauage here: https://github.com/rafamadriz/friendly-snippets/tree/main/snippets
  --         {
